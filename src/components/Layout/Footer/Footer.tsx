...
const Footer = () => {
    ...
    return (
        <footer className="bg-dark text-white py-3 w-full absolute bottom-0 left-0">
            <div className="container grid grid-cols-3 gap-4 items-center">
                ...
                {/* Phần văn bản ở giữa */}
                <span className="text-center col-span-1 fw-bold">
                    Copyright © {currentYear} Designed and Developed by [Nguyễn Phi Long]. All rights reserved
                </span>
